...
#include "../SP_QSP_HCC/abm/compartment/Tumor.h"
#include "../SP_QSP_HCC/abm/compartment/LymphCentral.h"
...
public:
	...
	//! Write the coordinate of vasulature file
...
private:
	...
	SP_QSP_IO::SP_QSP_HCC::Tumor _tumor;
