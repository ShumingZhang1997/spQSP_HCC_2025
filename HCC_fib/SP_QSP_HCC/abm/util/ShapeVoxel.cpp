...
const std::vector<CoordVec>& ShapeVoxel::getFibDestinationVoxels()const {
	//return _mooreDestinations;
	return _vonNeumannDestinations;
};

const std::vector<CoordVec>& ShapeVoxel::getVasDestinationVoxels()const {
	return _mooreDestinations;
	//return _vonNeumannDestinations;
};
...
const CoordVec& ShapeVoxel::getFibDirectionAnchor()const {
	//return _moore;
	return _vonNeumann;
};

const CoordVec& ShapeVoxel::getVasDirectionAnchor()const {
	return _moore;
	//return _vonNeumann;
};
