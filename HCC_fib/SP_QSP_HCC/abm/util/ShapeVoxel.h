...
public:
	...
	virtual const std::vector<CoordVec>& getFibDestinationVoxels()const;
	virtual const std::vector<CoordVec>& getVasDestinationVoxels()const;
	virtual const CoordVec& getMoveDirectionAnchor()const;
	virtual const CoordVec& getFibDirectionAnchor()const;
	virtual const CoordVec& getVasDirectionAnchor()const;
