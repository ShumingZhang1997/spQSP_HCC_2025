...
public:
	...
	//! get total number of Th cells
	int getTh()const;
	//! get total number of Treg cell
	int getTreg() const;
	//! get total number of MDSC cell
	int getMDSC() const;	
	//! get total number of APC cell
	int getAPC() const;
	//! get total number of M1 macrophage cell
	int getMacM1() const;
	//! get total number of M2 macrophage cell
	int getMacM2() const;
	//! get total number of Vas cell
	int getVas() const;
	//! get total number of CAFs cell
	int getFibCAFs() const;
	//! get total number of normal fibroblast cell
	int getFibNormal () const;
